                                ...
                                <div class="card-body">
                                    <h5 class="text-center p-4">
                                        <span style="float:left;">
                                            <a href="<?php echo site_url('card/stafflist')?>" class="btn btn-primary"> <i class="fa fa-users"> </i> Staff ID Cards</a>
                                        </span>
                                        Card Services
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($summary as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo strtoupper($row->division_name) ?></td>
                                                        
                                                        <td><?php echo $row->session_admitted; ?></td>
                                                        <td><?php echo $row->total; ?></td>
                                                        <td>
                                                            <a class="btn btn-info" href="<?php echo site_url('card/list/'.$row->programid).'/'.md5(rand()); ?>">
