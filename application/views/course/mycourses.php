                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-center">
                                        ...
                                        <?php echo isset($mycourses) ? (($mycourses[0]->value ?? '') ." Semester, ".($mycourses[0]->session ?? '') ) : $_SESSION['active_session'] ; ?>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($mycourses as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a target="_blank" class="btn btn-info" href="<?php echo site_url('course/enrollment/'.md5(time()).'/'. $row->id); ?>">
