...
<head>
    ...
    <title><?php echo 'Exams Card for '.$student->pnumber.' ('.$info->value.' Semester, '.$info->session.')'; ?></title>
...
<body class="font-muli right_tb_toggle" style="margin-left:2px; color:#000">
    <div id="main_content">
        <?php if (!file_exists('./passport/'.$student->passport)){
            echo "<p class='alert alert-danger text-center'>Passport NOT Uploaded, CAN NOT PRINT EXAMS CARD</p>";    
        }else{ ?>
                        ...
                        <div class="tab-pane active" id="Library-all">
                            <div class="card">
                                <div class="card-body"> 
                                        ...
                                        <div class="col-12 p-10">
                                            ...
                                            <table style=" width:100%; color:#000; font-size:19px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:left"><?php echo $info->value.' Semester, '.$info->session; ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12 p-10">
                                            <hr> <h2 class="text-left" style="font-size:27px;">Courses Registered for <?php echo $info->value.' Semester, '.$info->session; ?></h2><hr>
                                                        ...
                                                        foreach ($courses as $row) {
                                                            ...
                                                            echo "<td style='vertical-align:top'><b>" 
                                                                ...
                                                                if(isset($row->venue)){
                                                                    ...
                                                                    echo 'Check General TT';
                                                                }
                                                                echo substr($p_venues, 0, strlen($p_venues)-2)."</b><br></td>";
                                                            echo ($i % 4 == 0) ? "</tr><tr>" : "";
                                                            $i++;
                                                        }
                                                        ?>
