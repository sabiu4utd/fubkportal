                                            ...
                                            <tbody>
                                                ...
                                                foreach ($courselist as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-info" href="<?php echo site_url('course/allocate/'.md5(time()).'/'. $row->course_id); ?>">
                                                                <i class="fa fa-user-plus"></i>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a target="_blank" class="btn btn-info" href="<?php echo site_url('course/enrollment/'.md5(time()).'/'. $row->course_id); ?>">
