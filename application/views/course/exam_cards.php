                                        ...
                                        <tbody>
                                            ...
                                            foreach ($exams_cards as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $ready = ($row->id == $_SESSION['active_semester']) ? "Available" : "Unavailable"; ?></td>
                                                    <td class="text-info">
                                                        <?php if ($row->id == $_SESSION['active_semester']) { ?>
                                                        <span>
                                                            <a href="<?php echo site_url('course/printecard/' . md5(time() . rand()) . '/' . $row->id . '/' . md5(rand())) ?>" target="_blank">
