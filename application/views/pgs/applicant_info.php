...
<?php //var_dump($applicant_data); ?>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>FUBK-PGS Application Form Printout for <?php echo strtoupper($applicant_data->applicant->surname) . ' ' . ucwords(trim($applicant_data->applicant->firstname . ' ' .$applicant_data->applicant->middlename)) ?></title>
            ...
            <div class="card" style="color: #000;">
                <div class="row px-4">
                    <div class="col-12 mx-auto" style="display:flex; flex-direction: column; justify-content: center;">
                        ...
                        <div style="text-align: center;font-size:19px; font-weight:bold">Postgraduate School  Application Form</div>
                    </div>
        ...
        <div class="page">
            <div class="card" style="color: #000;">
                <div class="row px-4">
                    ...
                    <div class="col-12 p-2"><hr></div>
                    <div class="col-12">
                       <?php  if(!isset($applicant_data->referees[1]->recommendation)) {} else{ ?>
                        <table class="table table-bordered table-stripped colored" >
                            <tr>
                                <th>&nbsp;</th>
                                <th>Referee 1</th>
