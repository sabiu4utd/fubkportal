...
foreach($stats as $row){  
    $all_forms += $row->all_forms; 
    $submitted += $row->submitted; 
    $malesubmitted += $row->malesubmitted; 
    $femalesubmitted += $row->femalesubmitted; 
    $admitted += $row->admitted; 
    $maleadmitted += $row->maleadmitted; 
    $femaleadmitted += $row->femaleadmitted; 
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>
                                                        ...
                                                        <div class="num"><?php echo $all_forms;?></div>
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>
                                                        ...
                                                        <div class="num"><?php echo $submitted;?></div>
                                                        <div class="per"><?php echo number_format(100*$submitted/$all_forms, 2, '.', ',');?>%</div>
                                                    </span>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>
                                                        ...
                                                        <div class="num"><?php echo $not_submitted;?></div>
                                                        <div class="per"><?php echo number_format(100*$not_submitted/$all_forms, 2, '.', ',');?>%</div>
                                                    </span>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>
                                                        <div class="text-center" style="font-weight:900; padding-bottom:4px; font-size:17px">Male Applicants</div>
                                                        <div class="num"><?php echo $malesubmitted;?></div>
                                                        <div class="per"><?php echo number_format(100*$malesubmitted/$submitted, 2, '.', ',');?>%</div>
                                                    </span>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>
                                                        <div class="text-center" style="font-weight:900; padding-bottom:4px; font-size:17px">Female Applicants</div>
                                                        <div class="num"><?php echo $femalesubmitted;?></div>
                                                        <div class="per"><?php echo number_format(100*$femalesubmitted/$submitted, 2, '.', ',');?>%</div>
                                                    </span>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>
                                                        <div class="text-center" style="font-weight:900; padding-bottom:4px; font-size:17px">PhD Applicants</div>
                                                        <div class="num"><?php echo $PhD;?></div>
                                                        <div class="per"><?php echo number_format(100*$PhD/$PhD, 2, '.', ',');?>%</div>
                                                    </span>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>
                                                        <div class="text-center" style="font-weight:900; padding-bottom:4px; font-size:17px">Masters Applicants</div>
                                                        <div class="num"><?php echo $masters;?></div>
                                                        <div class="per"><?php echo number_format(100*$masters/$masters, 2, '.', ',');?>%</div>
                                                    </span>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="card-body">
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    <span>
                                                        <div class="text-center" style="font-weight:900; padding-bottom:4px; font-size:17px">PGD Applicants</div>
                                                        <div class="num"><?php echo $PGD;?></div>
                                                        <div class="per"><?php echo number_format(100*$PGD/$PGD, 2, '.', ',');?>%</div>
                                                    </span>
                                                </li>
                                            </ul>
                                        </div>
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($forms as $row) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php 
                                                                        if (strtolower($row->form_name) == 'school of postgraduate studies'){
                                                                            echo '<a href="'.site_url('pgs/viewall/'.$row->id) .'">View Forms</a>';
                                                                        }else{
                                                                            echo "-";
                                                                        }
                                                                        ?>
