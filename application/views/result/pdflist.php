                        ...
                        <div class="col-12">
                            <div class="card">
                                <h6 style="margin:auto;" class="card-body text-center">
                                    PDF Result Uploaded for <?php echo $semester.' semester, '.$session?>
                                </h6>
                            </div>
                        </div>
                    </div>
									...
									<table
										...
										<tbody>
											...
											<tr>
												...
												<td> 
													<a href="<?php echo site_url('result/pdflistdept/'.$row->deptid)?>" >
												...
												<td>
													<span>
													    <?php if ($row->status == "available"){ ?>
    														<a class="text-success"> <i class="fa fa-check-circle"></i>
                                                                <?php echo $row->status; ?>    
                                                            </a>
                                                        <?php }else { ?>
                                                            <a class="text-warning"> <i class="fa fa-times"></i>
                                                                <?php echo $row->status; ?>    
                                                            </a>
                                                        <?php }?>
													</span>
												...
												<td class="text-danger">
													<span>
													    <a class="text-danger" href="<?php echo site_url('result/dropall/'.$row->deptid.'/'.str_replace('/', '_', $row->session).'/'.$row->semester);?>" >
													       <i class="fa fa-times"></i> Drop ALL
													    </a>
													</span>
												</td>
												<td class="text-primary">
													<span>
													<a href="<?php echo site_url('result/listed/'.$row->deptid.'/'.str_replace('/', '_', $row->session).'/'.$row->semester);?>" > <i class="fa fa-eye"></i> View</a>
													</span>
												</td>
