                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="Library-all">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h3 class="text-center">Find Student's Result</h3>
                                    <form action="<?php echo site_url('result/studentsummary')?>" method="post">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" required name="pnumber" placeholder="Enter Student Admission Number"/>
                                            </div>
                                            <div class="col-md-4">
                                                <input type="submit" class="form-control btn btn-primary" value="View Results" />
                                            </div>
                                        </div>
                                    </form>
                                </div>
