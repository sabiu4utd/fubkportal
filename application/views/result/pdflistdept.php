                        ...
                        <div class="col-12">
                            <div class="card">
                                <h6 style="margin:auto;" class="card-body text-center">
                                    PDF Result Uploaded for <?php echo $summary[0]->dept_name?> department for all semesters
                                </h6>
                            </div>
                        </div>
                    </div>
									...
									<table
										...
										<tbody>
											...
											<tr>
												...
												<td>
                                                    <a href="<?php echo site_url('result/pdflist/'.str_replace("/","_",$row->session).'/'.$row->semester)?>" >
