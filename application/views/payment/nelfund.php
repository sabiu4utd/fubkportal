                    ...
                    <div class="d-flex justify-content-between align-items-center ">
                        <div class="header-action">
                            ...
                            <ol class="breadcrumb page-breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Nelfund Payments</a></li>
                            </ol>
                        </div>
            ...
            <div class="section-body mt-4">
                <div class="container-fluid">
                    <div class="row clearfix">
                        <div class="col-12">
                            <div class="card pt-4">
                                <h6 style="margin:auto; text-decoration:underline">Upload Nelfund Payment</h6>
                                <form class="card-body" action="<?php echo site_url('payment/uploadNelfund')?>" method="post"  enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <!--<label class="col-md-1 col-form-label">Session <span class="text-danger">*</span></label>-->
                                        <div class="col-md-3">
                                            <?php echo $_SESSION['active_session'] ?>
                                        </div>
                                        
                                        <label class="col-md-1 col-form-label">Excel File <span class="text-danger">*</span></label>
                                        <div class="col-md-4">
                                            <input type="file" class="form-control" name="file" required>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="submit" name="submit" value="Upload Payments" class="form-control btn btn-success block" style="width:100%" />
                                        </div>
                                    </div>
                                </form>
                            </div>
