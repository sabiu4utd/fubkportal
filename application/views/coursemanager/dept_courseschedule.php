                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="text-center">Course Schedule History</h4>
                                    <hr>
                                        ...
                                        <tbody>
                                            <?php $i = 1; foreach ($schedules as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('course/deptviewschedule/'.$row->programid.'/'.$row->level.'/'.hash('sha512', time()))?>" class="text-success">
