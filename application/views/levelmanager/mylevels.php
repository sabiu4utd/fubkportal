                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-center">LEVEL COORDINATION HISTORY</h5>
                                    <hr>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: left;">Update Codes</th>
                                        ...
                                        <tbody>
                                            <?php $i = 1; foreach ($levels as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('levelmanager/myview/'.hash('sha512', time()).'/'.$row->program_id.'/'.$row->level.'/'.$row->session_id.'/'.hash('sha512', time()))?>">
                                                    ...
                                                    <td>
                                                        <button type="button" 
                                                            ...
                                                            title="Update" 
                                                            data-type="update-creg-codes"
                                                            data-programid="<?php echo $row->program_id?>" 
                                                            data-level="<?php echo $row->level?>" 
                                                            data-sessionid="<?php echo $row->session_id?>" >
                                                            <i class="fa fa-pen"></i> Update Codes
                                                        </button>
                                                    </td><td>
                                                        <button type="button" 
                                                            class="btn btn-icon btn-sm js-sweetalert text-danger" 
                                                            title="Delete" 
    ...
    <script>
        $(function () {
            $('.js-sweetalert').on('click', function () {
                ...
                if (type === 'update-creg-codes') {
                    var programid = $(this).data('programid');
                    var level = $(this).data('level');
                    var sessionid = $(this).data('sessionid');
                    swal({
                        title: "Are you sure?",
                        text: "You are about to assign codes to students without codes!",
                        type: "info",
                        showCancelButton: true,
                        confirmButtonText: "Proceed!",
                        cancelButtonText: "Go Back!",
                        ...
                        if (isConfirm) {
                            $.post("<?php echo site_url('levelmanager/updateassign/')?>",
                              {
                                programid: programid,
                                level: level,
                                sessionid: sessionid,
                              ...
                              function(data, status){
                                  swal("Codes Refreshed!", "Code Registarion Codes have been updated.", "success");
                              });
                        } 
                    });
                }
