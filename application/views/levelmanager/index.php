...
<body class="font-muli right_tb_toggle <?php echo " " . $_SESSION['theme_mode']; ?>">
                        ...
                        <div class="col-xl-12">
                            <div class="row clearfix row-deck">
                                ...
                                <div class="col-md-2 col-sm-6 raise">
                                    <div class="card">
                                        <div class="card-body">
                                            <a href="<?php echo site_url('levelmanager/allocate') ?>" class="my_sort_cut text-muted">
                                                <i class="fa fa-user-secret float-left"></i>
                                                <span>Allocate Level Cordinator</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php $i = 1; foreach ($levels as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('levelmanager/view/'.hash('sha512', time()).'/'.$row->program_id.'/'.$row->level.'/'.$row->session_id.'/'.hash('sha512', time()))?>">
    ...
    <script src="<?php echo base_url() ?>assets/bundles/lib.vendor.bundle.js" type="text/javascript"></script>
    ...
    <script src="<?php echo base_url() ?>assets/plugins/dropify/js/dropify.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url() ?>assets/bundles/summernote.bundle.js" type="text/javascript"></script>

    <script src="<?php echo base_url() ?>assets/js/core.js" type="text/javascript"></script>
    <script src="<?php echo base_url() ?>assets/js/form/dropify.js" type="text/javascript">
    </script>
    <script src="<?php echo base_url() ?>assets/js/page/summernote.js" type="text/javascript">
    </script>
    <script src="<?php echo base_url() ?>assets/js/rocket-loader.min.js" data-cf-settings="|49" defer=""></script>
    
    <!--<script src="<?php echo base_url() ?>assets/js/page/dialogs.js" type="text/javascript"></script>-->
