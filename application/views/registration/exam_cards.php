                                        ...
                                        <tbody>
                                            ...
                                            foreach ($exams_cards as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        echo $ready = isset($_SESSION['ecard_ready_date']) ? (date('m-d-Y') < $_SESSION['ecard_ready_date']) ? "READY" : "NOT READY" : "NOT READY";
                                                        ?>
                                                    </td>
                                                    <td class="text-info">
                                                        <?php
                                                        ...
                                                        ?>
                                                            <span>
                                                                <a href="<?php echo site_url('registration/printecard/' . md5(time() . rand()) . '/' . $row->id . '/' . md5(rand())) ?>" target="_blank">
