                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 p-10">
                                            <?php 
                                                   echo "<a href='".site_url('registration/admin_reset_password/'.md5(rand()).'/'.$student_info->userid.'/'.md5(time()))."' class='btn btn-danger form-control'><i class='fa fa-lock' style='font-size: 15px'></i> Reset Password</a>" ; 
                                                ?>
                                        </div>
                                        <div class="col-12 p-10">
                                            <table  id= "myTable1" class="table table-stripped table-bordered">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php 
                                                            ...
                                                            if($student_info->session_admitted == $_SESSION['active_session'] and $student_info->confirm_status != "Confirmed"){
                                                                if(!$acceptanceFee){
                                                                    echo "<a href='".site_url('registration/generateAcceptanceRemita/'.$student_info->user_id)."'><i class='fa fa-person-booth text-info'></i> Generate Invoice</a>";
                                                                }else{
                                                                    ...
                                                                    if($acceptanceFee->status == "Pending"){
                                                                        echo "<br><a href='".site_url('registration/checkPaymentStatus/'.$student_info->user_id.'/'.$acceptanceFee->rrr)."'><i class='fa fa-person-booth text-info'></i> Confirm Payment</a>";
                                                                    }else{
                                                        ...
                                                        <?php 
                                                            ...
                                                            if(isset($acceptanceFee) && $acceptanceFee->status == "Paid"){
                                                                if($student_info->confirm_status == "Pending"){
                                                                    echo "<a href='".site_url('registration/admin_confirm_admission/'.md5(rand()).'/'.$student_info->userid.'/'.md5(time()))."' class='text-danger'> <i class='fa fa-question'></i> Verify &amp; Confirm Admission</a>";
                                                                }else{
                                                                ...
                                                                if(isset($acceptanceFee->rrr)){
                                                                    echo "<a href='".site_url('registration/checkPaymentStatus/'.$student_info->user_id.'/'.$acceptanceFee->rrr)."'><i class='fa fa-person-booth text-info'></i> Confirm Payment</a>";
                                                                }
                                                            ...
                                                            if($student_info->confirm_status == "Pending"){
                                                                ...
                                                                if(!$tuitionFee){
                                                                    if($student_info->entrymode == "PG"){
                                                                        echo "<a href='".site_url('registration/generateTuitionRemita/'.$student_info->user_id)."'><i class='fa fa-bank text-info'></i> Pay Full (100%) Tuition<br></a><br>";
                                                                        echo "<a href='".site_url('registration/generateTuitionRemita/'.$student_info->user_id.'/1')."'><i class='fa fa-bank text-info'></i> Pay Partial (60%) Tuition</a><br><br>";
                                                                        echo "<a href='".site_url('registration/generateTuitionRemita/'.$student_info->user_id.'/2')."'><i class='fa fa-bank text-info'></i> Pay Balance (40%) Tuition from Last Session</a>";
                                                                    }else{
                                                                        echo "<a href='".site_url('registration/generateTuitionRemita/'.$student_info->user_id)."'><i class='fa fa-bank text-info'></i> Generate Tuition Invoice<br></a>";
                                                                    }
                                                                }else{
                                                                    ...
                                                                    echo "<br><br><a href='".site_url('registration/generateTuitionRemita/'.$student_info->user_id.'/3')."'><i class='fa fa-bank text-info'></i> Pay Balance (40%) Tuition for this session</a>";
                                                                    if($tuitionFee->status != "Paid"){
                                                                        echo "<br><br><a href='".site_url('registration/checkPaymentStatus/'.$student_info->user_id.'/'.$tuitionFee->rrr)."'><i class='fa fa-person-booth text-info'></i> Confirm Payment</a>";
                                                                    }else{
                                                                        echo "<br><br><i class='fa fa-person-booth text-success'></i> PAID";
                                                                    }
                                                                }
                                                            }
                                                        ?>
                                                ...
                                                <?php if($student_info->entrymode == "PG"){ ?>
                                                <tr>
                                               
                                                    <th>Pay Percentage </th>
                                                    <td>
                                                        <!-- Button to trigger modal -->
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#payPercentageModal">
                                                             Pay Percentage
                                                        </button>

                                                        <!-- Modal -->
                                                        <div class="modal fade" id="payPercentageModal" tabindex="-1" role="dialog" aria-labelledby="payPercentageModalLabel" aria-hidden="true">
                                                          <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                              <div class="modal-header">
                                                                <h5 class="modal-title" id="payPercentageModalLabel">Pay Percentage </h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                  <span aria-hidden="true">&times;</span>
                                                                </button>
                                                              </div>
                                                              <div class="modal-body">
                                                                <form action="<?php echo site_url('registration/generatePercentageRemita/')?>" method="post">
                                                                    <div class="form-group">
                                                                        <label for="sessionSelect">Select Session</label>
                                                                        <select class="form-control" id="sessionSelect" name="session">
                                                                            <option value="70">2022/2023</option>
                                                                            <option value="73">2023/2024</option>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="percentageSelect" name="percentage">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" id="levelSelect" name="level" required>
                                                                            ...
                                                                            <option value="710">710 Level</option>
                                                                            <option value="720">720 Level</option>
                                                                            <option value="800">800 Level</option>
                                                                            <option value="810">810 Level</option>
                                                                            <option value="820">820 Level</option>
                                                                            <option value="900">900 Level</option>
                                                                            <option value="910">910 Level</option>
                                                                            <option value="920">920 Level</option>
                                                                        </select>
                                                                    </div>
                                                                    <input type="text" name="user_id" value="<?php echo $student_info->user_id?>" hidden/   >
                                                        ...
                                                        <?php
                                                            if($tuitionFee && $tuitionFee->status == "Paid"){
                                                                if($student_info->pnumber == "Unassigned"){
                                                                    echo "<a href='".site_url('registration/assignadmission_no/'.$student_info->user_id)."'><i class='fa fa-user'></i> Assign Admission No</a>";
                                                                }else{
                                                                    echo $student_info->pnumber;
                                                                    echo "<br><br><a target='_blank' href='".site_url('registration/printAdmissionLetter/'.$student_info->user_id)."'><i class='fa fa-print'></i> Print Admission Letter</a>";
                                                                }
                                                            }else{
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <form action="<?php echo site_url('registration/uploadPassport')?>" method="post" enctype="multipart/form-data" style="padding:20px">
