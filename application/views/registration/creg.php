                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table
										...
										<tbody>
											<?php $i = 1; foreach($creg_history as $row){ ?>
											<tr>
												<td><?php echo $i++; ?></td>
												<td><?php echo $row->value; ?></td>
												<td><?php echo $row->level; ?></td>
												<td class="text-primary">
                                                    <?php if(date("Y-m-d") > "2020-10-30"){
                                                        echo '<i class="fa fa-times-circle"></i> CLOSED';
                                                    }else{    
                                                    ?>
													<span style="font-weight:bolder">
                                                        <a href="<?php echo site_url('registration/adm_edit_creg/'.md5(rand()).'/'.$row->value.'/'.$row->studentid."/".md5(time()))?>">
                                                        <i class="fa fa-search-dollar text-info"></i> EDIT
                                                        </a>
													</span>
                                                    <?php } ?>
												</td>
                                                ...
                                                <td class="text-info">
													<span>
                                                        <a href="<?php echo site_url('registration/print_cform/'.md5(rand()).'/'.$row->id.'/'.$row->studentid."/".md5(time()))?>" target="_blank"><i class="fa fa-print"></i> Course Form</a>
                                                    </span>
												</td>
											</tr>
											<?php } ?>
