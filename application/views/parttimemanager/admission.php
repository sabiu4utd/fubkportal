                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-center">
                                        Admission List for <?php echo $list[0]->session_admitted ?? $_SESSION['sbs_session']; ?>                                      
                                        <span style="float:right;">
                                            <a href="<?php echo site_url('sbsmanager/index')?>"class="btn btn-success"><i class="fa fa-home"></i></a>
                                            </form>
                                        </span>
                                    </h5>
                                    <hr>
                                        ...
                                        <table class="table table-hover js-basic-example dataTable table-striped table_custom border-style spacing5">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($list as $row) { ?>
                                                    <tr>
                                                        <td><?php echo $i++; ?></td>
                                                        <td><?php echo ($row->pnumber == 'Unassigned' ? '<i class="fa fa-circle text-danger"></i>' : '<i class="fa fa-circle text-success"></i>').'&nbsp;'. strtolower($row->pnumber) ?></td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-info" href="<?php echo site_url('sbsmanager/candidate/'.md5(time().rand()).'/' . $row->user_id.'/'.md5(time().rand())); ?>">
