...
<?php
    //echo json_encode($stats, JSON_PRETTY_PRINT); die;
?>
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="col-xl-12">
                            <div class="row clearfix row-deck">
                                <div class=" col-12 mb-2 text-center">
                                    <h3 style="text-align:center" class="text-center">Part-Time Manager</h3>
                                </div>

                                <div class="col-6 col-md-2 raise">
                                    <div class="card">
                                        <div class="card-body">
                                            <a href="<?php echo site_url('parttimemanager/') ?>" class="my_sort_cut text-muted">
                                                <i class="fa fa-home"></i>
                                                <span>Part-Time Home</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-md-2 raise">
                                    <div class="card">
                                        <div class="card-body">
                                            <a href="<?php echo site_url('parttimemanager/admissions') ?>" class="my_sort_cut text-muted">
                                ...
                                <div class="col-6 col-md-2 raise">
                                    <div class="card">
                                        <div class="card-body">
                                            <a href="<?php echo site_url('parttimemanager/registrations') ?>" class="my_sort_cut text-muted">
                                            ...
                                            <tbody>
                                                ...
                                                if($row->program_id > 21){ ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-info btn-sm" href="<?php echo site_url('parttimemanager/view/' . md5(time() . rand()) . '/'.$row->program_id).'/0/'. md5(time() . rand()); ?>"></a>
