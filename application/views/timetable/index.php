            ...
            <div class="section-body mt-4">
                <div class="container-fluid">
                    <div class="row clearfix">
                        <div class="col-12">
                            <div class="card">
                                <h6 style="margin:auto; text-decoration:underline; margin-top:10px; padding-top:10px">Upload New Timetable</h6>
                                <form class="card-body" action="<?php echo site_url('timetabling/upload')?>" method="post"  enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label class="col-md-1 col-form-label">Type <span class="text-danger">*</span></label>
                                        <div class="col-md-2">
                                        ...
                                        <label class="col-md-1 col-form-label">Semester <span class="text-danger">*</span></label>
                                        <div class="col-md-2">
                                        ...
                                        <label class="col-md-1 col-form-label">Timetable File <span class="text-danger">*</span></label>
                                        <div class="col-md-3">
                                            <input type="file" class="form-control" name="file" required>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="submit" name="submit" value="Upload Timetable" class="form-control btn btn-success block" style="width:100%" />
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
									<table
										...
										<tbody>
											<?php $i = 1; foreach($timetables as $row){ ?>
											<tr>
												<td>
													<?php echo $i++; ?>
												</td>
												<td> 
													<?php echo $row->value.' semester, '.$row->session ?> 
												</td>
												<td>
												...
												<td class="text-primary">
													<span>
													<?php  if($row->session == $_SESSION['active_session']){ ?>
													<a href="<?php echo site_url('timetabling/tt/'.md5(time()).'/'.$row->id.'/'.$row->type);?>" class="btn btn-primary"> <i class="fa fa-user-shield"></i> Manage</a>
													<?php }else{ echo "-"; } ?>
													</span>
												</td>
											</tr>
