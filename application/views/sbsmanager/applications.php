                                                        ...
                                                        <table class="table table-hover js-basic-example dataTable table-striped table_custom border-style spacing5" id="myTable">
                                                            <thead>
                                                                 <?php 
                                                                    ...
                                                                    $program = "SBS Science";
                                                                    if($this->uri->segment(4) == 22) $program = "SBS ARTS";
                                                                    if($this->uri->segment(4) == 23) $program = "SBS SCIENCE";
                                                                    if($this->uri->segment(4) == 24) $program = "SBS ENVIRONMENTAL";
                                                                    if($this->uri->segment(4) == 25) $program = "SBS REMEDIAL/MATRIC";
                                                                ...
                                                                ?>
                                                                <tr> <th colspan="13" class="text-center" style="color:#000"><h3>List of <?php echo '<b>'.$filter.'</b> Applicants for <b>'.$program ?></b></h3></th></tr>
                                                                <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php 
                                                                            if($row->prog_abbr == "SBS Science"){
                                                                                ...
                                                                                echo "ARTS";
                                                                            }else if($row->prog_abbr == "SBS Remedial/Matric"){
                                                                                echo "R/MATRIC";
                                                                            } else if($row->prog_abbr == "SBS Remedial/Science") {
                                                                                echo "R/SCIE"; 
                                                                            } else if($row->prog_abbr == "SBS Remedial/Arts"){
                                                                               echo "R/ARTS";  
                                                                            } else{
                                                                                echo "ENVI"; 
                                                                            }
