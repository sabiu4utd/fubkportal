                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8 text-center">
                                            ...
                                            <h5 style="font-weight: bolder;">
                                                <?php echo $record['info']['semester_name']." Semester, ".$record['info']['session_name']." Session"; ?></h5>
                                        </div>
                                        <div class="col-2">
                                            <img src="https://mis.fubk.edu.ng/assets/passport/<?php echo $record['detail']->passport; ?>" style="width:110px; height:120px; float:right" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="user-info-list">
                                                <table style="font-weight: bolder; width:100%; color:#000; font-size:16px;">
                                                    <tr>
                                                        <td>FULL NAME</td>
                                                        <td><?php echo strtoupper($record['detail']->surname) . " " . ucwords(strtolower($record['detail']->firstname . " " .  $record['detail']->othernames)); ?></td>
                                                        <td>ADMISSION NO</td>
                                                        <td><?php echo $record['detail']->pnumber; ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td>FACULTY</td>
                                                        <td><?php echo $record['detail']->division_name; ?></td>
                                                        <td>DEPARTMENT</td>
                                                        <td><?php echo $record['detail']->dept_name; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>PROGRAM</td>
                                                        <td><?php echo $record['detail']->prog_abbr; ?></td>
                                                        <td>LEVEL</td>
                                                        <td>
                                                            <?php
                                                            //echo $record['info']['level'].'***';
                                                            if ($record['info']['level'] < 6) {
                                                                echo $record['info']['level']. "00";
                                                            } else if ($record['info']['level'] == 9) {
                                                                echo "Spill Over I";
                                                            } else if ($record['info']['level'] == 10) {
                                                                echo "Spill Over II";
                                                            }
                                                            ?>
                                                        </td>
                                                ...
                                                <table class="res_summary" style="width: 100%; color:#000; font-size:16px; border-collapse:collapse" border="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center"><?php echo $record['result_info']['ls']['cu']; ?></td>
                                                        <td style="text-align:center"><?php echo $record['result_info']['ls']['gp']; ?></td>
                                                        <td style="text-align:center"><?php echo $record['result_info']['ls']['gpa']; ?></td>
                                                        <td rowspan="3" style="padding:7px; vertical-align:top; text-align:left">
                                                            <?php
                                                            if (count($record['carryovers']) == 0) {
                                                                echo "<b>PASSED</b>";
                                                            } else {
                                                                foreach ($record['carryovers'] as $row) {
                                                                    echo substr($row, 0, 6).", ";
                                                                }
                                                            }
                                                            ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="text-align:center"><?php echo $record['result_info']['ts']['cu']; ?></th>
                                                        <th style="text-align:center"><?php echo $record['result_info']['ts']['gp']; ?></th>
                                                        <th style="text-align:center"><?php echo $record['result_info']['ts']['gpa']; ?></th>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align:left">Cummulative</td>
                                                        <td style="text-align:center"><?php echo $record['result_info']['td']['cu']; ?></td>
                                                        <td style="text-align:center"><?php echo $record['result_info']['td']['gp']; ?></td>
                                                        <td style="text-align:center"><?php echo $record['result_info']['td']['gpa']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">
