                    ...
                    <div class="d-flex justify-content-between align-items-center ">
                        <div class="header-action">
                            ...
                            <ol class="breadcrumb page-breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">ACL Manager</a></li>
                            </ol>
                        </div>
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-xl-12">
                            <div class="row clearfix row-deck">
                                ...
                                <div class="col-6 col-md-2 raise">
                                    <div class="card">
                                        <div class="card-body">
                                            <a href="<?php echo site_url('settingmanager/roles') ?>" class="my_sort_cut text-muted">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="Library-all">
                            <div class="card">
                                <div class="card-body">
                                    <a href="<?php echo site_url('settingmanager/addrole')?>" class="float-left btn btn-primary d-block">Add New Role</a>
									<table
