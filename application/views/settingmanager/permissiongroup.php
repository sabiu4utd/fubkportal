                    ...
                    <div class="d-flex justify-content-between align-items-center ">
                        <div class="header-action">
                            ...
                            <ol class="breadcrumb page-breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Permission Group Manager</a></li>
                            </ol>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
									...
									<table
										...
										<tbody>
											<?php $i = 1; foreach($permissiongroup as $row){ ?>
											<tr>
												<td><?php echo $i++; ?></td>
												...
												<td class="text-left">
													<span>
													   <a href="<?php echo site_url('settingmanager/editpermissiongroup/'.$row->id)?>">
