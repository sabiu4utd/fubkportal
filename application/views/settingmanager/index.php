            ...
            <div class="section-body mt-4">
                <div class="container-fluid">
                    <div class="row clearfix">
                        <div class="col-12">
                            <div class="card">
                                <h6 style="margin:auto; text-decoration:underline">Change Session</h6>
                                <form class="card-body" action="<?php echo site_url('settingmanager/')?>" method="post"  enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <label class="col-md-2 col-form-label text-right">Session <span class="text-danger">*</span></label>
                                        <div class="col-md-7">
                                        ...
                                        <div class="col-md-3">
                                            <input type="submit" name="submit" value="Set Current Session" class="form-control btn btn-success block" style="width:100%" />
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="card-body">
									<table
										...
										<tbody>
											...
											<tr>
												<td><?php echo $i++; ?></td>
												<td><?php echo strtoupper($row->setting);?></td>
												<td><?php 
												    echo strtoupper($row->value);
												    echo strtoupper($row->value) == 'CLOSED' ? ' <i class="fa fa-times text-danger"></i>' : '';    
												?></td>
												<td><?php echo strtoupper($row->session);?></td>
												<td><?php echo strtoupper($row->start_date);?></td>
												<td><?php echo strtoupper($row->end_date);?></td>
												<td>
