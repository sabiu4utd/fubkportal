                                        ...
                                        <table class="table table-hover js-basic-example dataTable table-striped table_custom border-style spacing5">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align:left; font-weight:bolder; color:#000">Payment Status</th>
                                                ...
                                                <?php $i = 1;foreach ($result as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php 
                                                                echo $row->hostelcode."/";
                                                                if($row->location == "Permanent Site"){echo "PS"; }
                                                                if($row->location == "Take-Off Site"){echo "TS"; }
                                                                if($row->location == "College of Health Sciences"){echo "CHS"; }
                                                            ?>
                                                        ...
                                                        <td><?php echo $row->current_level ?></td>
                                                         ...
                                                         <td>Remita Not Generated</td>
                                                      
                                                        <td><a href="<?php echo site_url('accomodations/revoke/'.$row->hostelid."/".$row->user_id."/".$row->bedspaceid); ?>">Revoke</a> <?php }  ?></td>
                                                    </tr>
