...
class Sbsmanager extends CI_Controller {
	...
	public function index(){
	    ...
	    curl_setopt_array($curl, [
          CURLOPT_URL => "https://eforms.fubk.edu.ng/formapi/formstatsbs",
		...
		return $this->load->view('sbsmanager/index', $data);
		
	}
	
	public function view(){
		$_SESSION['pageTitle'] = 'SBS Application .::. University Portal';
        ...
        curl_setopt_array($curl, [
          CURLOPT_URL => "https://eforms.fubk.edu.ng/formapi/sbsforms/".$form_type."/".$form_status,
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 30,
		...
		return $this->load->view('sbsmanager/applications', $data);
	}
